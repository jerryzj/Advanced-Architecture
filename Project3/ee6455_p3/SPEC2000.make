...
##################################################
#
#   EE6455 Advanced Computer Architectures
...
# Your simplescalar simulation root, you have to modify this to your directory where you place your sim-outorder 
SIM_DIR  = ./simplesim-3.0

# CPU2000 benchmark direcotry, you have to modify this to your SPEC directory
SIM_DIR_SPEC2000INT = ./CPU2000int
SIM_DIR_SPEC2000FP  = ./CPU2000fp

# The simulator name
SIM_BIN   = sim-outorder

# configuration file for your simulator
SIM_CONFIG = -config default.baseline.cfg

# additional simulation knobs
SIM_KNOBS  = $(SIM_CONFIG) -fastfwd 1000000000 -max:inst 1000000000
...
$(RESULT_DIR)/ammp.ref.stdout: $(SIM_DIR)/$(SIM_BIN)
	...
	-$(SIM_DIR)/redir.sh  $(RESULT_DIR)/ammp.ref.stdout \
	  ...
	  < ammp.in
	 rm ammp.in all.init.ammp init_cond.run*
